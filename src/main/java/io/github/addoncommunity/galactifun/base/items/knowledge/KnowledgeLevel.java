    ...
    BASIC {
        ...
        public void addLore(@Nonnull List<Component> lore, @Nonnull PlanetaryWorld world) {
            if (!world.atmosphere().effects().isEmpty()) {
                ...
                lore.add(Component.text("Эффекты:").color(NamedTextColor.GRAY));
    ...
    ADVANCED {
        ...
        public void addLore(@Nonnull List<Component> lore, @Nonnull PlanetaryWorld world) {
            ...
            if (Math.abs(world.atmosphere().pressure()) > 1e-6) {
                lore.add(Component.empty());
                lore.add(Component.text("Состав атмосферы:").color(NamedTextColor.GRAY));
            ...
            lore.add(Component.empty());
            lore.add(Component.text("Гравитация: ")
                    .color(NamedTextColor.GRAY)
