...
public final class Firestorm extends Alien<Blaze> implements Listener {
    ...
    private void onPlayerDeath(PlayerDeathEvent e) {
        ...
        if (s.endsWith(" был поражен молнией во время битвы с Огненным Штормом")) {
            e.deathMessage(Component.text(e.getEntity().getName() + " был убит электрическим током из Огненного Шторма"));
        }
    }
